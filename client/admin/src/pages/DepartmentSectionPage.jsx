      ...
      <nav className="bg-[#0D9488] text-white shadow-lg sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex justify-between items-center">
          ...
          <div className="bg-white/10 px-4 py-1.5 rounded-lg border border-white/20 text-right">
            ...
            <span className="text-sm font-medium">{adminId || "N/A"}</span>
          </div>
        </div>
      </nav>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-200 sticky top-24">
              ...
              <p className="text-xs text-gray-500 mb-6 leading-relaxed">
                Generate student accounts automatically by defining a range of roll numbers.
              </p>
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                <p className="text-sm text-gray-500">View and manage student profiles for this section.</p>
              </div>
                  ...
                  {students.length === 0 ? (
                    <tr>
                      <td colSpan="4" className="px-6 py-20 text-center text-gray-400">
                        ...
                        <p className="text-sm italic">Generate accounts using the form on the left.</p>
                      </td>
                    </tr>
                  ) : (
